...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    /**
     * 发起路线规划搜索示例
     *布局中所有按钮的onclick属性都是searchButtonProcess,所以下面用swich判断,分别实现驾驶,公交,步行等
     * @param v
     */
    public void searchButtonProcess(View v) {
        ...
        //withCityNameAndPlaceName通过地名和城市名确定出行节点信息,参数(城市名,地点名)
    ...
    public void nodeClick(View v) {
        ...
        //DrivingRouteLine.DrivingStep是一个内部类
